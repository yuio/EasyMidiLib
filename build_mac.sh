...
if [ "$CONFIG" = "Debug" ]; then
    ...
    clang++ -c -g -O0 -arch arm64 -Iinclude src/EasyMidiLib_macCoreMidi.cpp -o _intermediate/Debug/EasyMidiLib_arm64.o
    ...
    clang++ -c -O2 -arch arm64 -Iinclude src/EasyMidiLib_macCoreMidi.cpp -o _intermediate/Release/EasyMidiLib_arm64.o
